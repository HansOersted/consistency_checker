...
mpc_param_file_path = "path/to/mpc.param.yaml"
pid_param_file_path = "path/to/pid.param.yaml"
simulator_model_param_file_path = "path/to/simulator_model.param.yaml"

# read the YAML files
mpc_params = read_yaml(mpc_param_file_path)
pid_params = read_yaml(pid_param_file_path)
